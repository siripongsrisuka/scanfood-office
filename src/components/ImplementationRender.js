...
const initialProcess = ['demo','payment','setup','implementation','training','softlaunch'];

function ImplementationRender({ handleProfile, portStores, setLoading }) {
...
export default ImplementationRender;
