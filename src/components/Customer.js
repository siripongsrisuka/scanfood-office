...
import { daysDifference, findInArray, goToTop, searchFilterFunction, someInArray } from "../Utility/function";
    ...
    <div  >
        ...
        />
              ...
              <div style={styles.container} >
                <Button style={styles.container2}  variant={category==='ทั้งหมด'?'dark':'light'} onClick={()=>{setCategory('ทั้งหมด')}} >
                  ทั้งหมด
                </Button>
                <Button style={styles.container3}  variant={category==='เฉพาะมี package'?'dark':'light'} onClick={()=>{setCategory('เฉพาะมี package')}}   >
                  เฉพาะมี package
                </Button>
                <Button style={styles.container3}  variant={category==='น้อยกว่า 30 วัน'?'dark':'light'} onClick={()=>{setCategory('น้อยกว่า 30 วัน')}}   >
                    น้อยกว่า 30 วัน
                </Button>
                <Button style={styles.container3}  variant={category==='น้อยกว่า 10 วัน'?'dark':'light'} onClick={()=>{setCategory('น้อยกว่า 10 วัน')}}   >
                    น้อยกว่า 10 วัน
                </Button>
              </div>
