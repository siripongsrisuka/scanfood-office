...
function Modal_FlatListTypeColumn({
  ...
  searchKey=['name']
    ...
    useEffect(()=>{
        let results= value;
        if(search){
            results = searchMultiFunction(value,search,searchKey)
        } 
        if(type){
...
const styles = {
    ...
    container3 : {
      minHeight:'85vh',maxHeight:'85vh', overflowY: 'auto'
    },
    container4 : {
...
export default Modal_FlatListTypeColumn;
